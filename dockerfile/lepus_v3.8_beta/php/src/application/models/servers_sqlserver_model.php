<?php 
class Servers_sqlserver_model extends CI_Model{

    protected $table='db_servers_sqlserver';
...
/* End of file servers_sqlserver_model.php */
/* Location: ./application/models/servers_sqlserver_model.php */